...
export const fa: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      out: "خروجی",
      total: "جمع",
      stale: "در حال به‌روزرسانی…",
      metaSep: "·",
      contextShort: "زمینه ~{pct}%",
      lastShort: "آخرین نوبت +{tokens}",
      titleIn: "ورودی",
      titleOut: "خروجی",
      titleTotal: "جمع",
      titleLimit: "سقف زمینه {limit} (~{pct}%)",
      titleLast: "آخرین نوبت +{tokens}",
      aria: "توکن‌های نشست: جمع {total}، ورودی {input}، خروجی {output}. {detail}",
      ariaNoDetail: "بدون سقف زمینه یا مصرف آخرین نوبت.",
    },
  },
  languages: {
    en: "English (انگلیسی)",
