...
export const id: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Memperbarui…",
      metaSep: "·",
      contextShort: "konteks ~{pct}%",
      lastShort: "putaran terakhir +{tokens}",
      titleIn: "Masukan",
      titleOut: "Keluaran",
      titleTotal: "Total",
      titleLimit: "Batas konteks {limit} (~{pct}%)",
      titleLast: "Putaran terakhir +{tokens}",
      aria: "Token sesi: total {total}, masuk {input}, keluar {output}. {detail}",
      ariaNoDetail: "Tidak ada batas konteks atau penggunaan putaran terakhir.",
    },
  },
  languages: {
    en: "Inggris",
