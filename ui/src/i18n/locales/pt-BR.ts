...
export const pt_BR: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Atualizando…",
      metaSep: "·",
      contextShort: "contexto ~{pct}%",
      lastShort: "última rodada +{tokens}",
      titleIn: "Entrada",
      titleOut: "Saída",
      titleTotal: "Total",
      titleLimit: "Limite de contexto {limit} (~{pct}%)",
      titleLast: "Última rodada +{tokens}",
      aria: "Tokens da sessão: total {total}, entrada {input}, saída {output}. {detail}",
      ariaNoDetail: "Sem limite de contexto ou uso da última rodada.",
    },
  },
  languages: {
    en: "Inglês",
