...
export const uk: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Оновлення…",
      metaSep: "·",
      contextShort: "контекст ~{pct}%",
      lastShort: "останній хід +{tokens}",
      titleIn: "Вхід",
      titleOut: "Вихід",
      titleTotal: "Усього",
      titleLimit: "Ліміт контексту {limit} (~{pct}%)",
      titleLast: "Останній хід +{tokens}",
      aria: "Токени сесії: усього {total}, вхід {input}, вихід {output}. {detail}",
      ariaNoDetail: "Немає ліміту контексту чи використання за останній хід.",
    },
  },
  languages: {
    en: "Англійська",
