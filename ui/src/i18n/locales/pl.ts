...
export const pl: TranslationMap = {
  ...
  controlUiThemes: {
    claw: { label: "Claw", desc: "Rodzina Chroma" },
    knot: { label: "Knot", desc: "Czerń i czerwień" },
    dash: { label: "Dash", desc: "Czekoladowy blueprint" },
    urban: { label: "Urban", desc: "Wysoki kontrast i akcenty" },
  },
  overview: {
    access: {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Aktualizacja…",
      metaSep: "·",
      contextShort: "kontekst ~{pct}%",
      lastShort: "ostatnia tura +{tokens}",
      titleIn: "Wejście",
      titleOut: "Wyjście",
      titleTotal: "Suma",
      titleLimit: "Limit kontekstu {limit} (~{pct}%)",
      titleLast: "Ostatnia tura +{tokens}",
      aria: "Tokeny sesji: suma {total}, wejście {input}, wyjście {output}. {detail}",
      ariaNoDetail: "Brak limitu kontekstu lub użycia z ostatniej tury.",
    },
  },
  languages: {
