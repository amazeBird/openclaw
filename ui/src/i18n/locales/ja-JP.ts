...
export const ja_JP: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "更新中…",
      metaSep: "·",
      contextShort: "コンテキスト約 {pct}%",
      lastShort: "直近ターン +{tokens}",
      titleIn: "入力",
      titleOut: "出力",
      titleTotal: "合計",
      titleLimit: "コンテキスト上限 {limit}（約 {pct}%）",
      titleLast: "直近ターン +{tokens}",
      aria: "セッショントークン：合計 {total}、入力 {input}、出力 {output}。{detail}",
      ariaNoDetail: "コンテキスト上限または直近ターンの使用量がありません。",
    },
  },
  languages: {
    en: "英語",
