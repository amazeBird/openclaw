...
export const fr: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Mise à jour…",
      metaSep: "·",
      contextShort: "contexte ~{pct} %",
      lastShort: "dernier tour +{tokens}",
      titleIn: "Entrée",
      titleOut: "Sortie",
      titleTotal: "Total",
      titleLimit: "Plafond de contexte {limit} (~{pct} %)",
      titleLast: "Dernier tour +{tokens}",
      aria: "Jetons de session : total {total}, entrée {input}, sortie {output}. {detail}",
      ariaNoDetail: "Pas de plafond de contexte ni d’usage du dernier tour.",
    },
  },
  languages: {
    en: "Anglais",
