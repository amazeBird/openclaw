...
export const it: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Aggiornamento…",
      metaSep: "·",
      contextShort: "contesto ~{pct}%",
      lastShort: "ultimo turno +{tokens}",
      titleIn: "Input",
      titleOut: "Output",
      titleTotal: "Totale",
      titleLimit: "Limite di contesto {limit} (~{pct}%)",
      titleLast: "Ultimo turno +{tokens}",
      aria: "Token di sessione: totale {total}, in {input}, out {output}. {detail}",
      ariaNoDetail: "Nessun limite di contesto o utilizzo dell’ultimo turno.",
    },
  },
  languages: {
    en: "English (Inglese)",
