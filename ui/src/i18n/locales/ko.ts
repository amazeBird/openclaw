...
export const ko: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "업데이트 중…",
      metaSep: "·",
      contextShort: "컨텍스트 ~{pct}%",
      lastShort: "직전 턴 +{tokens}",
      titleIn: "입력",
      titleOut: "출력",
      titleTotal: "합계",
      titleLimit: "컨텍스트 한도 {limit} (~{pct}%)",
      titleLast: "직전 턴 +{tokens}",
      aria: "세션 토큰: 합계 {total}, 입력 {input}, 출력 {output}. {detail}",
      ariaNoDetail: "컨텍스트 한도나 직전 턴 사용량이 없습니다.",
    },
  },
  languages: {
    en: "영어",
