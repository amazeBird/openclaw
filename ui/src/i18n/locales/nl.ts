...
export const nl: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      lastShort: "laatste beurt +{tokens}",
      titleIn: "Invoer",
      titleOut: "Uitvoer",
      titleTotal: "Totaal",
      titleLimit: "Contextlimiet {limit} (~{pct}%)",
      titleLast: "Laatste beurt +{tokens}",
      aria: "Sessietokens: totaal {total}, in {input}, uit {output}. {detail}",
      ariaNoDetail: "Geen contextlimiet of gebruik van de laatste beurt.",
    },
  },
  languages: {
    en: "English (Engels)",
