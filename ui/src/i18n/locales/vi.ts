...
export const vi: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Đang cập nhật…",
      metaSep: "·",
      contextShort: "ngữ cảnh ~{pct}%",
      lastShort: "lượt trước +{tokens}",
      titleIn: "Đầu vào",
      titleOut: "Đầu ra",
      titleTotal: "Tổng",
      titleLimit: "Giới hạn ngữ cảnh {limit} (~{pct}%)",
      titleLast: "Lượt trước +{tokens}",
      aria: "Token phiên: tổng {total}, vào {input}, ra {output}. {detail}",
      ariaNoDetail: "Không có giới hạn ngữ cảnh hoặc dùng lượt trước.",
    },
  },
  languages: {
