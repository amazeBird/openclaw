...
import { loginFailureStringsZhCN } from "./snippets/login-failure-zh-CN.ts";
...
export const zh_CN: TranslationMap = {
  ...
  login: {
    ...
    hidePassword: "隐藏密码",
    togglePasswordVisibility: "切换密码可见性",
    failure: loginFailureStringsZhCN,
  },
  chat: {
    ...
    tokenStrip: {
      ...
      titleLast: "上轮 +{tokens}",
      aria: "会话 Token：合计 {total}，入 {input}，出 {output}。{detail}",
