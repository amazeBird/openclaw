...
export const tr: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Güncelleniyor…",
      metaSep: "·",
      contextShort: "bağlam ~{pct}%",
      lastShort: "son tur +{tokens}",
      titleIn: "Girdi",
      titleOut: "Çıktı",
      titleTotal: "Toplam",
      titleLimit: "Bağlam üst sınırı {limit} (~{pct}%)",
      titleLast: "Son tur +{tokens}",
      aria: "Oturum jetonları: toplam {total}, girdi {input}, çıktı {output}. {detail}",
      ariaNoDetail: "Bağlam üst sınırı veya son tur kullanımı yok.",
    },
  },
  languages: {
    en: "İngilizce",
