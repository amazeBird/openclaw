...
export const ar: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "جارٍ التحديث…",
      metaSep: "·",
      contextShort: "السياق ~{pct}%",
      lastShort: "آخر دورة +{tokens}",
      titleIn: "الإدخال",
      titleOut: "الإخراج",
      titleTotal: "الإجمالي",
      titleLimit: "حد السياق {limit} (~{pct}%)",
      titleLast: "آخر دورة +{tokens}",
      aria: "رموز الجلسة: الإجمالي {total}، داخل {input}، خارج {output}. {detail}",
      ariaNoDetail: "لا يوجد حد للسياق أو استخدام آخر دورة.",
    },
  },
  languages: {
