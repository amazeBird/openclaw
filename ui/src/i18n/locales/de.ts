...
export const de: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      out: "out",
      total: "ges.",
      stale: "Aktualisierung…",
      metaSep: "·",
      contextShort: "Kontext ~{pct} %",
      lastShort: "zuletzt +{tokens}",
      titleIn: "Input",
      titleOut: "Output",
      titleTotal: "Gesamt",
      titleLimit: "Kontextlimit {limit} (~{pct} %)",
      titleLast: "Letzter Turn +{tokens}",
      aria: "Sitzungs-Tokens: gesamt {total}, in {input}, out {output}. {detail}",
      ariaNoDetail: "Kein Kontextlimit oder letzter Turn erfasst.",
    },
  },
  languages: {
    en: "English",
