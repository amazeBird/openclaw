...
export const de: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      lastShort: "Letzte Runde +{tokens}",
      titleIn: "Eingabe",
      titleOut: "Ausgabe",
      titleTotal: "Gesamt",
      titleLimit: "Kontextlimit {limit} (~{pct} %)",
      titleLast: "Letzte Runde +{tokens}",
      aria: "Sitzungs-Tokens: gesamt {total}, ein {input}, aus {output}. {detail}",
      ariaNoDetail: "Kein Kontextlimit oder Verbrauch der letzten Runde.",
    },
  },
  languages: {
    en: "Englisch",
