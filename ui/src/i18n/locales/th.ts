...
export const th: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "กำลังอัปเดต…",
      metaSep: "·",
      contextShort: "บริบท ~{pct}%",
      lastShort: "รอบล่าสุด +{tokens}",
      titleIn: "อินพุต",
      titleOut: "เอาต์พุต",
      titleTotal: "รวม",
      titleLimit: "ขีดจำกัดบริบท {limit} (~{pct}%)",
      titleLast: "รอบล่าสุด +{tokens}",
      aria: "โทเค็นเซสชัน: รวม {total} เข้า {input} ออก {output} {detail}",
      ariaNoDetail: "ไม่มีขีดจำกัดบริบทหรือการใช้รอบล่าสุด",
    },
  },
  languages: {
    en: "อังกฤษ",
