...
export const en: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      stale: "Updating…",
      metaSep: "·",
      contextShort: "context ~{pct}%",
      lastShort: "last +{tokens}",
      titleIn: "Input",
      titleOut: "Output",
      titleTotal: "Total",
      titleLimit: "Context cap {limit} (~{pct}%)",
      titleLast: "Last turn +{tokens}",
      aria: "Session tokens: total {total}, in {input}, out {output}. {detail}",
      ariaNoDetail: "No context limit or last-turn usage on record.",
    },
  },
  languages: {
    en: "English",
  ...
  config: {
    ...
    appearance: {
      ...
      themeClaw: "Claw",
      themeClawDesc: "Chroma family",
      themeDash: "Dash",
      themeDashDesc: "Chocolate blueprint",
      themeKnot: "Knot",
      themeKnotDesc: "Black & red",
      themeUrban: "Urban",
      themeUrbanDesc: "Dark tech with lime highlights",
