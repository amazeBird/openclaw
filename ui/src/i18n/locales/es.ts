...
export const es: TranslationMap = {
  ...
  chat: {
    ...
    tokenStrip: {
      ...
      lastShort: "último turno +{tokens}",
      titleIn: "Entrada",
      titleOut: "Salida",
      titleTotal: "Total",
      titleLimit: "Límite de contexto {limit} (~{pct} %)",
      titleLast: "Último turno +{tokens}",
      aria: "Tokens de sesión: total {total}, entrada {input}, salida {output}. {detail}",
      ariaNoDetail: "Sin límite de contexto ni uso del último turno.",
    },
  },
  languages: {
    en: "Inglés (English)",
