...
/** Default assistant portrait (U001); lives in `ui/public/`. */
...
/** Chat: prefer real custom URLs; skip gateway placeholder avatars; else static Fariy art. */
...
export function assistantAvatarFallbackUrl(basePath: string): string {
  return defaultAssistantPortraitUrl(basePath);
}
